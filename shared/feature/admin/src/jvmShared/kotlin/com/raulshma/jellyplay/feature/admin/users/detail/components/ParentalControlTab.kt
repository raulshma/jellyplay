...
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_allow_tags
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_allow_tags_desc
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_block_tags
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_block_tags_desc
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_block_unrated
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_block_unrated_desc
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_max_parental_rating
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_max_parental_rating_desc
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_no_limit
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_rating
...
fun ParentalControlTab(
    ...
    Column(
        ...
        UserEditSection(
            title = stringResource(Res.string.admin_max_parental_rating),
            description = stringResource(Res.string.admin_max_parental_rating_desc),
        ) {
        ...
        UserEditSection(
            title = stringResource(Res.string.admin_block_unrated),
            description = stringResource(Res.string.admin_block_unrated_desc),
        ) {
        ...
        UserEditSection(
            title = stringResource(Res.string.admin_allow_tags),
            description = stringResource(Res.string.admin_allow_tags_desc),
        ) {
            TagEditor(
                label = stringResource(Res.string.admin_allow_tags),
        ...
        UserEditSection(
            title = stringResource(Res.string.admin_block_tags),
            description = stringResource(Res.string.admin_block_tags_desc),
        ) {
            TagEditor(
                label = stringResource(Res.string.admin_block_tags),
...
private fun MaxParentalRatingField(
    ...
    ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
            value = if (selected.name == "No limit") stringResource(Res.string.admin_no_limit) else selected.name,
            onValueChange = {},
            readOnly = true,
            label = { Text(stringResource(Res.string.admin_rating)) },
        ...
        ExposedDropdownMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
            options.forEach { option ->
                DropdownMenuItem(
                    text = { Text(if (option.name == "No limit") stringResource(Res.string.admin_no_limit) else option.name) },
                    onClick = {
                        onPolicyChange(
                            policy.copy(
