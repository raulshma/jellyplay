...
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_catalog_tab
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_installed_tab
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_plugin_experimental
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_plugin_management_alpha
...
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_repositories_tab
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_uninstall
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_uninstall_plugin_confirm_title
...
fun PluginsScreen(
    ...
    JellyPlayScreenScaffold(
        title = stringResource(Res.string.admin_plugins_title),
        onBack = onBack,
        ...
        Column(
            ...
            PrimaryTabRow(
                ...
                Tab(
                    ...
                    text = { Text(stringResource(Res.string.admin_installed_tab)) },
                )
                Tab(
                    ...
                    text = { Text(stringResource(Res.string.admin_catalog_tab)) },
                )
                Tab(
                    ...
                    text = { Text(stringResource(Res.string.admin_repositories_tab)) },
                )
            }
    ...
    pendingUninstallId?.let { pluginId ->
        ConfirmDialog(
            title = stringResource(Res.string.admin_uninstall_plugin_confirm_title),
...
private fun AlphaBanner() {
    Card(
        ...
        Row(
            ...
            Column {
                Text(
                    text = stringResource(Res.string.admin_plugin_management_alpha),
                    style = MaterialTheme.typography.bodyMedium,
                    fontWeight = FontWeight.SemiBold,
                    color = MaterialTheme.colorScheme.onTertiaryContainer,
                )
                Text(
                    text = stringResource(Res.string.admin_plugin_experimental),
