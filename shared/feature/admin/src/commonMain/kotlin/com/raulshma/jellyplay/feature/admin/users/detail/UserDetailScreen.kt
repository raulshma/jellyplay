...
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_delete_user_body
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_delete_user_title
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_discard
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_dismiss
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_leave_blank_password
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_new_password
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_reset
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_reset_password
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_save_changes
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_set
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_set_password
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_tab_access
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_tab_account
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_tab_parental
...
fun UserDetailScreen(
    ...
    if (state.showDeleteDialog && user != null) {
        ConfirmDialog(
            ...
            message = stringResource(Res.string.admin_delete_user_body, user.name),
    ...
    if (state.showPasswordDialog) {
        ...
        ImeAlertDialog(
            ...
            title = { Text(if (newPassword.isBlank()) stringResource(Res.string.admin_reset_password) else stringResource(Res.string.admin_set_password)) },
            text = {
                Column {
                    PasswordTextField(
                        value = newPassword,
                        onValueChange = { newPassword = it },
                        label = { Text(stringResource(Res.string.admin_new_password)) },
                        modifier = Modifier.fillMaxWidth(),
                        contentType = ContentType.NewPassword,
                    )
                    if (newPassword.isBlank()) {
                        Text(
                            stringResource(Res.string.admin_leave_blank_password),
            ...
            confirmButton = {
                ...
                ) { Text(if (newPassword.isBlank()) stringResource(Res.string.admin_reset) else stringResource(Res.string.admin_set)) }
            },
            dismissButton = {
                TextButton(onClick = {
                    viewModel.dismissPasswordDialog()
                ...
                Box(modifier = Modifier.fillMaxSize()) {
                    ...
                    AnimatedVisibility(
                        ...
                        BottomAppBar(modifier = Modifier.fillMaxWidth()) {
                            TextButton(onClick = viewModel::discard, modifier = Modifier.padding(start = 8.dp)) { Text(stringResource(Res.string.admin_discard)) }
                            Spacer(Modifier.weight(1f))
                            Button(onClick = viewModel::save, modifier = Modifier.padding(end = 8.dp)) { Text(stringResource(Res.string.admin_save_changes)) }
                        }
                    }
                }
            }
...
private fun UserEditTabBar(
    ...
    val labels = listOf(Res.string.admin_tab_profile, Res.string.admin_tab_access, Res.string.admin_tab_parental, Res.string.admin_tab_account)
