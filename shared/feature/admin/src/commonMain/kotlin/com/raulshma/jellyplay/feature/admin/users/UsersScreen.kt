...
import com.raulshma.jellyplay.feature.admin.generated.resources.admin_add_user_cd
                    ...
                    PullToRefreshBox(
                        ...
                        if (state.users.isEmpty()) {
                            ScreenEmptyState(
                                ...
                                title = stringResource(Res.string.admin_no_users),
                                actionLabel = stringResource(Res.string.admin_add_user_cd),
                            ...
                            LazyColumn(
                                ...
                                if (isTv) {
                                    item(key = "create_user", contentType = "create_user") {
                                        AddListRow(
                                            label = stringResource(Res.string.admin_add_user_cd),
                                            icon = Tabler.Outline.UserPlus,
