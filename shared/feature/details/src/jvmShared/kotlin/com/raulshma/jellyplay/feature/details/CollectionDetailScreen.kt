...
import com.raulshma.jellyplay.feature.details.generated.resources.detail_collection_empty_description
import com.raulshma.jellyplay.feature.details.generated.resources.detail_collection_empty_title
...
fun CollectionDetailScreen(
    ...
    // Long-press / TV-Menu quick actions for collection cards, on the shared
                    ...
                    AnimatedVisibility(
                        ...
                        if (items.isEmpty()) {
                            com.raulshma.jellyplay.core.ui.components.ScreenEmptyState(
                                ...
                                title = stringResource(Res.string.detail_collection_empty_title),
                                description = stringResource(Res.string.detail_collection_empty_description),
                        ...
                        TvFocusableGrid(
                            ...
                            onFocusedIndexChange = { index -> items.getOrNull(index)?.let { quickActionIntake.tvFocusedItem = it } },
