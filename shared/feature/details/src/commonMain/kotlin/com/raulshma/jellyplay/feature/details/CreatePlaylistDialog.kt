...
import com.raulshma.jellyplay.feature.details.generated.resources.detail_playlist_create
import com.raulshma.jellyplay.feature.details.generated.resources.detail_playlist_desc_label
import com.raulshma.jellyplay.feature.details.generated.resources.detail_playlist_name_label
import com.raulshma.jellyplay.feature.details.generated.resources.detail_playlist_new_title
...
internal fun CreatePlaylistDialog(
    ...
    ImeAlertDialog(
        ...
        title = { Text(stringResource(Res.string.detail_playlist_new_title)) },
        text = {
            Column {
                OutlinedTextField(
                    value = name,
                    onValueChange = { name = it },
                    label = { Text(stringResource(Res.string.detail_playlist_name_label)) },
                    singleLine = true,
                    enabled = !isLoading,
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.detail_playlist_desc_label)) },
                    minLines = 2,
                    maxLines = 4,
                    enabled = !isLoading,
        ...
        confirmButton = {
            TextButton(
                ...
                if (isLoading) {
                    ...
                    Text(stringResource(Res.string.detail_playlist_create))
                }
            }
        },
        dismissButton = {
