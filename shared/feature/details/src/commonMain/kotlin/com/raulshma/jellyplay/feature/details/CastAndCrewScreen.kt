...
import com.raulshma.jellyplay.feature.details.generated.resources.detail_section_crew
...
fun CastAndCrewScreen(
    ...
    onBack: () -> Unit,
    viewModel: CastAndCrewViewModel = koinViewModel(),
) {
    ...
    JellyPlayScreenScaffold(
        title = stringResource(Res.string.detail_section_cast_crew),
        onBack = onBack,
                        ...
                        item(span = { GridItemSpan(maxLineSpan) }) {
                            Column(
                                ...
                                OutlinedTextField(
                                    ...
                                    placeholder = {
                                        Text(stringResource(CoreUiRes.string.core_search))
                                    },
                                    singleLine = true,
                                )
                                    ...
                                    CastCrewTab.entries.forEach { option ->
                                        FilterChip(
                                            ...
                                            label = {
                                                Text(
                                                    when (option) {
                                                        CastCrewTab.CAST -> stringResource(Res.string.detail_section_cast)
                                                        CastCrewTab.CREW -> stringResource(Res.string.detail_section_crew)
                                                    },
                                                )
                                            },
