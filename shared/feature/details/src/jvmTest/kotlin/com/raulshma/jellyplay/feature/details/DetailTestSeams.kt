...
internal fun fakeDetailStrings(): DetailStrings = DetailStrings { res, args ->
    when (res) {
        Res.string.detail_resume_episode -> "Resume S${args[0]}:E${args[1]}"
        Res.string.detail_next_up_episode -> "NextUp S${args[0]}:E${args[1]}"
        Res.string.detail_play_episode -> "Play S${args[0]}:E${args[1]}"
        Res.string.detail_replay_episode -> "Replay S${args[0]}:E${args[1]}"
