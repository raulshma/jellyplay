 ...
 *
 * KMP split (player-live conveyor): the commonMain surface below is the
 * pure-state contract the shared ViewModel drives; the Media3 surface
 * (PlayerView attachment, raw volume) lives in the androidMain sub-interface
 * [Media3LivePlayerEngine], which only the Android screen/engine implement.
 */
