...
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_back
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_channel_down
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_channel_title_with_number
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_channel_up
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_channels
...
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_mute
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_pause
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_play
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_play_from_start
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_record
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_seek_back
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_seek_forward
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_stream_options
import com.raulshma.jellyplay.feature.player.live.generated.resources.live_unmute
...
fun LivePlayerTopBar(
    ...
    Row(
        ...
        PlayerIconButton(
            ...
            contentDescription = stringResource(Res.string.live_back),
            onClick = onBack,
        )
        ...
        Column(modifier = Modifier.weight(1f)) {
            Text(
                text = channel.number?.let {
                    stringResource(Res.string.live_channel_title_with_number, it, channel.name)
                } ?: channel.name,
        ...
        if (canRecord) {
            ...
            PlayerIconButton(
                ...
                contentDescription = stringResource(Res.string.live_record),
                onClick = onRecord,
        ...
        PlayerIconButton(
            ...
            contentDescription = if (isMuted) stringResource(Res.string.live_unmute) else stringResource(Res.string.live_mute),
            onClick = onMute,
        )
    }
}
    ...
    Column(
        ...
        Row(
            ...
            PlayerIconButton(
                ...
                contentDescription = stringResource(Res.string.live_play_from_start),
                onClick = onPlayFromStart,
                enabled = canSeek,
            )
            PlayerIconButton(
                icon = Tabler.Outline.PlayerTrackPrev,
                contentDescription = stringResource(Res.string.live_seek_back),
                onClick = onSeekBack,
                enabled = canSeek,
            )
            PlayerIconButton(
                icon = if (isPlaying) Tabler.Outline.PlayerPause else Tabler.Outline.PlayerPlay,
                contentDescription = if (isPlaying) stringResource(Res.string.live_pause)
                else stringResource(Res.string.live_play),
                onClick = onPlayPause,
            )
            PlayerIconButton(
                icon = Tabler.Outline.PlayerTrackNext,
                contentDescription = stringResource(Res.string.live_seek_forward),
            ...
            PlayerIconButton(
                ...
                contentDescription = stringResource(Res.string.live_channel_up),
                onClick = onChannelUp,
            )
            PlayerIconButton(
                icon = Tabler.Outline.ChevronDown,
                contentDescription = stringResource(Res.string.live_channel_down),
                onClick = onChannelDown,
            )
            Spacer(Modifier.width(16.dp))
            PlayerIconButton(
                icon = Tabler.Outline.Menu2,
                contentDescription = stringResource(Res.string.live_channels),
                onClick = onChannels,
            )
            PlayerIconButton(
                icon = Tabler.Outline.DotsVertical,
                contentDescription = stringResource(Res.string.live_stream_options),
                onClick = onMore,
            )
        }
    }
