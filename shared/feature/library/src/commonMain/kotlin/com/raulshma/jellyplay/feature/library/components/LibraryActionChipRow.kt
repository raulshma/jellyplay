...
import com.raulshma.jellyplay.feature.library.generated.resources.library_action_size
import com.raulshma.jellyplay.feature.library.generated.resources.library_grid_view
import com.raulshma.jellyplay.feature.library.generated.resources.library_list_view
import com.raulshma.jellyplay.feature.library.generated.resources.library_masonry_view
import com.raulshma.jellyplay.feature.library.generated.resources.library_thumb_view
...
fun LibraryActionChipRow(
    ...
    val (viewIcon, viewLabel) = when (viewMode) {
        LibraryViewMode.GRID -> Tabler.Outline.LayoutGrid to stringResource(Res.string.library_grid_view)
        LibraryViewMode.THUMB -> Tabler.Outline.Stack2 to stringResource(Res.string.library_thumb_view)
        LibraryViewMode.LIST -> Tabler.Outline.List to stringResource(Res.string.library_list_view)
        LibraryViewMode.MASONRY -> Tabler.Outline.LayoutGrid to stringResource(Res.string.library_masonry_view)
    }
    ...
    LazyRow(
        ...
        item(key = "size") {
            LibraryActionChip(
                ...
                label = stringResource(Res.string.library_action_size),
                onClick = onSizeClick,
            )
        }
        item(key = "group") {
