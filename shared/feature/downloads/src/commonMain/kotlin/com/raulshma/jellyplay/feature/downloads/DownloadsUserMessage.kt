 ...
 * [DownloadsScreen], which posts the resolved text to the shared UserMessageBus
 * — the commonMain-safe replacement for the legacy `UiText.Resource(R.string.downloads_deleted_message)`
