...
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_home_mode
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_home_sections
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_nav_labels
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_nav_labels_subtitle
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_subtitle
import com.raulshma.jellyplay.feature.onboarding.generated.resources.onboarding_home_layout_title
...
fun HomeLayoutStep(
    ...
    Column(
        ...
        OnboardingStepScaffold(
            title = stringResource(Res.string.onboarding_home_layout_title),
            subtitle = stringResource(Res.string.onboarding_home_layout_subtitle),
            icon = Tabler.Outline.LayoutGrid,
            onNext = {},
        ) {
            Text(
                text = stringResource(Res.string.onboarding_home_layout_home_mode),
            ...
            OnboardingToggleRow(
                title = stringResource(Res.string.onboarding_home_layout_nav_labels),
                subtitle = stringResource(Res.string.onboarding_home_layout_nav_labels_subtitle),
            ...
            Text(
                text = stringResource(Res.string.onboarding_home_layout_home_sections),
                style = MaterialTheme.typography.titleSmall,
                fontWeight = FontWeight.SemiBold,
                color = MaterialTheme.colorScheme.onSurface,
            )
