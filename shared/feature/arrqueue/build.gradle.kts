...
kotlin {
    ...
    // web breadth: the target compiles (data deps are
    // wasm-resolvable — ArrRepository has a wasm binding in DataWasmModule);
    // the web shell does not register the queue entry yet (orchestrator
