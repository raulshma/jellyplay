...
import com.raulshma.jellyplay.feature.search.generated.resources.search_filter_played_all
import com.raulshma.jellyplay.feature.search.generated.resources.search_filter_played_played
import com.raulshma.jellyplay.feature.search.generated.resources.search_filter_played_unplayed
...
fun SearchSortSheet(
    ...
    SearchSelectionSheet(title = stringResource(Res.string.search_sort_by), onDismiss = onDismiss) {
        FlowRow(
...
fun SearchStatusSheet(
    ...
    SearchSelectionSheet(title = stringResource(Res.string.search_filter_status), onDismiss = onDismiss) {
        FlowRow(
            horizontalArrangement = Arrangement.spacedBy(8.dp),
            verticalArrangement = Arrangement.spacedBy(8.dp),
        ) {
...
fun PlayedStatus.playedStatusLabel(): String = when (this) {
    PlayedStatus.ALL -> stringResource(Res.string.search_filter_played_all)
    PlayedStatus.PLAYED -> stringResource(Res.string.search_filter_played_played)
    PlayedStatus.UNPLAYED -> stringResource(Res.string.search_filter_played_unplayed)
}
