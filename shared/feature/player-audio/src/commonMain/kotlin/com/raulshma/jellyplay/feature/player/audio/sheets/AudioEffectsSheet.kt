...
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_auto_eq_description
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_balance_center
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_balance_left
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_balance_right
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_bass_boost
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_dialogue_boost
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_lr_balance
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_night_mode
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_pitch
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_pitch_original
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_pitch_value
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_reverb
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_title
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_effects_virtualizer
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_menu_equalizer
import com.raulshma.jellyplay.feature.player.audio.generated.resources.audio_open
...
internal fun AudioEffectsSheet(
    ...
    PlayerModalBottomSheet(
        ...
        LazyColumn(
            ...
            item {
                SheetHeader(
                    title = stringResource(Res.string.audio_effects_title),
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(stringResource(Res.string.audio_menu_equalizer), style = MaterialTheme.typography.bodyLarge)
                    }
                    Row {
                        TextButton(onClick = onOpenEqualizer) { Text(stringResource(Res.string.audio_open)) }
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Spacer(Modifier.width(8.dp))
                            Column {
                                Text(stringResource(Res.string.audio_effects_bass_boost), style = MaterialTheme.typography.bodyLarge)
                                Text(
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Column {
                                Text(stringResource(Res.string.audio_effects_virtualizer), style = MaterialTheme.typography.bodyLarge)
                            Text(
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Text(stringResource(Res.string.audio_effects_reverb), style = MaterialTheme.typography.bodyLarge)
                    }
                }
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Spacer(Modifier.width(8.dp))
                            Column {
                                Text(stringResource(Res.string.audio_effects_dialogue_boost), style = MaterialTheme.typography.bodyLarge)
                                Text(
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Spacer(Modifier.width(8.dp))
                            Column {
                                Text(stringResource(Res.string.audio_effects_night_mode), style = MaterialTheme.typography.bodyLarge)
                                Text(
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Column {
                            Text(stringResource(Res.string.audio_effects_lr_balance), style = MaterialTheme.typography.bodyLarge)
                            Text(
                                when {
                                    state.lrBalance < 0f -> stringResource(Res.string.audio_effects_balance_left, kotlin.math.abs((state.lrBalance * 100).toInt()))
                                    state.lrBalance > 0f -> stringResource(Res.string.audio_effects_balance_right, (state.lrBalance * 100).toInt())
                                    else -> stringResource(Res.string.audio_effects_balance_center)
                                },
                                style = MaterialTheme.typography.labelSmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Column {
                            Text(stringResource(Res.string.audio_effects_pitch), style = MaterialTheme.typography.bodyLarge)
                            Text(
            ...
            item {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Column {
                            Text(stringResource(Res.string.audio_effects_auto_eq), style = MaterialTheme.typography.bodyLarge)
                            Text(
                                stringResource(Res.string.audio_effects_auto_eq_description),
                                style = MaterialTheme.typography.labelSmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                        }
