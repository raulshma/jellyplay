...
class NextEpisodeOverlayTest {
    ...
    fun nextEpisodeOverlay_visible_showsContent() {
        ...
        // The badge string is "Next episode" and the series line renders as
        // the shared episodePlayerSubtitle derivation "Series · S2E5"
        // (unpadded code) — the series name is not a standalone node.
        ...
        composeTestRule.onNodeWithText("Test Series · S2E5").assertIsDisplayed()
    }
        ...
        composeTestRule.setContent {
            MaterialTheme {
                NextEpisodeOverlay(
                    ...
                    seasonNumber = null,
                    episodeNumber = null,
                    // The play/cancel affordances are rendered inside the
                    // thumbnail block, so a thumbnail URL is required for the
                    // buttons to exist at all.
    ...
    fun nextEpisodeOverlay_dismissed_hidesContent() {
        ...
        composeTestRule.onNodeWithContentDescription("Cancel").performClick()
        // Cancel sets `dismissed`, but the card leaves through an
        // AnimatedVisibility exit — wait for the animation to finish instead
        // of asserting against the mid-exit tree.
        composeTestRule.waitUntil(5_000) {
            composeTestRule.onAllNodesWithText("Next episode").fetchSemanticsNodes().isEmpty()
        }
    }
    ...
    fun nextEpisodeOverlay_seasonEpisodeFormatting() {
        ...
        composeTestRule.onNodeWithText("Show · S1E1").assertIsDisplayed()
    }
}
