...
/**
 * Platform registration fragment for the music feature's platform seams
 ...
 *    the home badge — jvmShared adapters in dataJvmModule). The rest of the
 *    VMs' graph (MediaRepository,
 *    the promoted playlist repositories, DownloadIntake, OfflineModeManager,
 *    HomeDiscoveryStore, ImageUrlProvider, MusicMessageBus) resolves from
