...
import com.raulshma.jellyplay.feature.music.generated.resources.music_move_down
import com.raulshma.jellyplay.feature.music.generated.resources.music_move_up
...
import com.raulshma.jellyplay.feature.music.generated.resources.music_remove_from_playlist
    ...
    Row(
        ...
        if (onAddToQueue != null) {
            ...
            DropdownMenu(
                ...
                if (onMoveUp != null) {
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.music_move_up)) },
                        onClick = {
                            onMoveUp()
                            showMenu = false
                        },
                ...
                if (onMoveDown != null) {
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.music_move_down)) },
                        onClick = {
                            onMoveDown()
                            showMenu = false
                        },
                ...
                if (onRemoveFromPlaylist != null) {
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.music_remove_from_playlist), color = MaterialTheme.colorScheme.error) },
                        onClick = {
