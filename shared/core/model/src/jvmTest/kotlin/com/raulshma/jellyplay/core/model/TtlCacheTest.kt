...
"value2",
    ...
    fun removeByKeyPrefix_leavesNonMatchingEntriesIntact() {
        ...
        assertNull(cache.get("similar_item-1_12"))
        assertEquals(
cache.get("similar_item-2_12"),
"different-item",
)
        assertEquals(
cache.get("xsimilar_item-1_12"),
...
"value-B",
    ...
    fun removeByKeyPrefix_identityAware_scopedToThatIdentity() {
        ...
        assertEquals(
cache.get(identityB, "similar_item1_5"),
"b1",
)
        assertEquals(
cache.get(identityB, "similar_item1_10"),
"b2",
)
    }
