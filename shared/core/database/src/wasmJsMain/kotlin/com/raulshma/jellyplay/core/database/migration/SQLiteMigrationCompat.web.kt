...
/**
 * web actual (wasmJs): [androidx.sqlite.SQLiteConnection.prepare] and
 * [androidx.sqlite.SQLiteStatement.step] are suspend calls here (the wasm
 * sqlite driver is async under the hood); the bodies are textually identical
 * to the nonWeb actuals in jvmShared (see SQLiteMigrationCompat.kt for the
 * full story).
 */
