...
class EpgGridLayoutTest {
    ...
    @Test
    fun `buildEpgGridData groups programs by channel and preserves channel order`() {
    ...
    @Test
    fun `buildEpgGridData filters programs entirely outside the window`() {
    ...
    @Test
    fun `buildEpgGridData keeps programs that partially overlap the window`() {
        val channels = listOf(channel("a"))
        val programs = listOf(
    ...
    @Test
    fun `buildEpgGridData sorts programs within a channel by start time`() {
        val channels = listOf(channel("a"))
        val programs = listOf(
    ...
    @Test
    fun `buildEpgGridData preserves empty channels as empty rows`() {
    ...
    @Test
    fun `layoutChannelRow computes start offset and width from minutes at 4 dp per minute`() {
    ...
    @Test
    fun `layoutChannelRow clamps programs partially outside the window`() {
        val grid = buildEpgGridData(
            channels = listOf(channel("a")),
            programs = listOf(
    ...
    @Test
    fun `layoutChannelRow skips programs with unparseable timestamps`() {
        val grid = buildEpgGridData(
            channels = listOf(channel("a")),
            programs = listOf(
                LiveTvProgram(
    ...
    @Test
    fun `buildTimeMarkers aligns to hour boundaries inside the window`() {
    ...
    @Test
    fun `buildTimeMarkers returns empty list for an inverted window`() {
    ...
    @Test
    fun `offsetDp scales minutes by 4 dp per minute`() {
        val start = Instant.parse("2026-06-22T14:00:00Z")
    ...
    @Test
    fun `offsetDp is negative for timestamps before the window`() {
        val start = Instant.parse("2026-06-22T14:00:00Z")
    ...
    @Test
    fun `toInstantOrNull parses ISO-8601 with offset`() {
    ...
    @Test
    fun `toInstantOrNull parses ISO-8601 with explicit offset`() {
    ...
    @Test
    fun `toInstantOrNull parses LocalDateTime as UTC fallback`() {
    ...
    @Test
    fun `toInstantOrNull returns null for invalid input`() {
    ...
    @Test
    fun `EpgGridData reports total width based on 4 dp per minute window`() {
        val grid = buildEpgGridData(
    ...
    @Test
    fun `EpgGridData isEmpty when no channels`() {
