...
val PreferenceCategoryViews: List<PreferenceCategoryView> = listOf(
    PreferenceCategoryView(PreferenceResetCategory.APPEARANCE, Tabler.Outline.Palette, R.string.factory_reset_cat_appearance) { p, f -> appearanceFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.PLAYBACK, Tabler.Outline.PlayerPlay, R.string.factory_reset_cat_playback) { p, f -> playbackFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.AUDIO, Tabler.Outline.Volume, R.string.factory_reset_cat_audio) { p, f -> audioFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.SUBTITLES_LANGUAGE, Tabler.Outline.Subtitles, R.string.factory_reset_cat_subtitles_language) { p, f -> subtitlesLanguageFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.DOWNLOADS_NETWORK, Tabler.Outline.Download, R.string.factory_reset_cat_downloads_network) { p, f -> downloadsNetworkFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.HOME_DISCOVERY, Tabler.Outline.Home, R.string.factory_reset_cat_home_discovery) { p, f -> homeDiscoveryFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.AUDIO_CACHE, Tabler.Outline.Music, R.string.factory_reset_cat_audio_cache) { p, f -> audioCacheFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.SECURITY, Tabler.Outline.ShieldLock, R.string.factory_reset_cat_security) { p, f -> securityFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.NOTIFICATIONS, Tabler.Outline.Bell, R.string.factory_reset_cat_notifications) { p, f -> notificationsFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.SCREENSAVER, Tabler.Outline.Moon, R.string.factory_reset_cat_screensaver) { p, f -> screensaverFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.NEWSLETTER, Tabler.Outline.PlayerTrackNext, R.string.factory_reset_cat_newsletter) { p, f -> newsletterFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.SYNCPLAY_CASTING, Tabler.Outline.ScreenShare, R.string.factory_reset_cat_syncplay_casting) { p, f -> syncplayCastingFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.PLAYER_ENGINES, Tabler.Outline.Cpu, R.string.factory_reset_cat_player_engines) { p, f -> playerEnginesFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.EXPERIMENTAL, Tabler.Outline.Flask, R.string.factory_reset_cat_experimental) { p, f -> experimentalFields(p, f) },
    PreferenceCategoryView(PreferenceResetCategory.MISC_APP, Tabler.Outline.Settings, R.string.factory_reset_cat_misc_app) { p, f -> miscAppFields(p, f) },
)
