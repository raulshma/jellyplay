...
class PlaybackRequestFactory(private val context: Context) {
    ...
    fun forPreview(
        ...
        val hostUri = materialize(RAW_HOST_CLIP_RES_ID, HOST_CLIP_NAME).toUri()
    ...
    private companion object {
        ...
        // Raw resource IDs are stable within this module's R class; referencing
        // the constant keeps the call site decoupled from generated IDs.
        val RAW_HOST_CLIP_RES_ID: Int =
            com.raulshma.jellyplay.feature.subtitle.tester.R.raw.subtester_host_clip
    }
}
