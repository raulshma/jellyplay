            ...
            when {
                ...
                requestError != null -> {
                    ...
                    Column {
                        ...
                        // Season picker for TV shows (we use basic season numbers)
                        if (isTv) {
                            ...
                            // Show basic season chips (we don't have season details here)
                            Text(
                                text = "Note: All seasons will be requested. Season selection requires detail view.",
