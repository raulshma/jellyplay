...
interface JellyfinApiClient {
    ...
    suspend fun getMetadataEditorInfo(itemId: String): Result<com.raulshma.jellyplay.core.model.MetadataEditorInfo>
    ...
    suspend fun getItemImageInfo(itemId: String): Result<List<com.raulshma.jellyplay.core.model.ImageInfo>>
    ...
    suspend fun getRemoteImages(
        ...
        startIndex: Int? = null,
        limit: Int? = null,
    ): Result<com.raulshma.jellyplay.core.model.RemoteImageResult>

    suspend fun getRemoteImageProviders(itemId: String): Result<List<com.raulshma.jellyplay.core.model.ImageProviderInfo>>
    ...
    suspend fun getUsers(): Result<List<com.raulshma.jellyplay.core.model.JellyfinUser>>

    suspend fun getUserPlayedItemCount(
        userId: String,
        includeItemTypes: List<String>? = null,
    ): Result<Int>

    suspend fun getUserUnplayedItemCount(
        userId: String,
        includeItemTypes: List<String>? = null,
    ): Result<Int>

    suspend fun getItemsWithUserData(
        userId: String,
        includeItemTypes: List<String>? = null,
        ...
        startIndex: Int = 0,
        limit: Int = 50,
    ): Result<Pair<Int, List<MediaItem>>>

    suspend fun getStaleItems(
        daysThreshold: Int,
    ...
    suspend fun getWatchedItems(
        userId: String,
        includeItemTypes: List<String>,
        minDaysSincePlayed: Int = 0,
        keepFavorites: Boolean = true,
        parentId: String? = null,
        startIndex: Int = 0,
        limit: Int = 200,
    ): Result<Pair<Int, List<com.raulshma.jellyplay.core.model.WatchedMediaItem>>>

    suspend fun deleteItem(itemId: String): Result<Unit>

    suspend fun deleteItems(itemIds: List<String>): Result<Int>

    suspend fun checkPlaybackReportingPlugin(): Result<com.raulshma.jellyplay.core.model.PlaybackReportingStatus>

    suspend fun getPlaybackReportingUserActivity(
        days: Int = 30,
    ): Result<List<com.raulshma.jellyplay.core.model.PlaybackReportingActivity>>

    suspend fun getPlaybackReportingPlayActivity(
        days: Int = 30,
        dataType: String = "count",
        filter: String? = null,
    ): Result<List<com.raulshma.jellyplay.core.model.PlaybackActivityPoint>>

    suspend fun getPlaybackReportingUserItems(
        userId: String,
        date: String,
        filter: String? = null,
    ): Result<List<com.raulshma.jellyplay.core.model.PlaybackReportingDetail>>
