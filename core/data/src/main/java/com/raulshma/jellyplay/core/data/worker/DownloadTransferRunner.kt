 ...
 */
internal class DownloadTransferRunner(
     ...
     * [existingBytes] > 0). Returns the WorkManager [Result]. The caller owns
     * the concurrency permit and has already set the row to DOWNLOADING.
     *
     ...
     * the outcome to the row, and maps it to a WorkManager [Result]. The single
     ...
     */
    private suspend fun sizeMismatch(downloadId: String, downloadPath: String, downloadedBytes: Long): Result {
