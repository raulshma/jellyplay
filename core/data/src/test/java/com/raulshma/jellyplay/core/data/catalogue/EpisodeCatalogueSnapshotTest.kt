...
class EpisodeCatalogueSnapshotTest {
    ...
    fun fetchedSeasonIds_excludesSeasonsGroupedUnderBlankKey() {
        ...
        assertTrue("real season must not be marked fetched", "season1" !in snapshot.fetchedSeasonIds)
        assertTrue("blank key is technically present", "" in snapshot.fetchedSeasonIds)
    }
