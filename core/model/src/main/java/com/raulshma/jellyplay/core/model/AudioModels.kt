...
enum class ReverbPreset(val displayName: String, val androidPreset: Short) {
    NONE("None", -1),
    SMALL_ROOM("Small Room", android.media.audiofx.PresetReverb.PRESET_SMALLROOM),
    MEDIUM_ROOM("Medium Room", android.media.audiofx.PresetReverb.PRESET_MEDIUMROOM),
    LARGE_ROOM("Large Room", android.media.audiofx.PresetReverb.PRESET_LARGEROOM),
    MEDIUM_HALL("Medium Hall", android.media.audiofx.PresetReverb.PRESET_MEDIUMHALL),
    LARGE_HALL("Large Hall", android.media.audiofx.PresetReverb.PRESET_LARGEHALL),
    PLATE("Plate", android.media.audiofx.PresetReverb.PRESET_PLATE),
}
