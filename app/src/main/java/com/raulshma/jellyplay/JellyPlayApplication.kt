        ...
        get() = Configuration.Builder()
            .setWorkerFactory(
                DelegatingWorkerFactory().apply {
                    ...
                    // TODO(8A-merge): core-data legacy workers — uncomment
                    // together with the androidCoreDataModule/
                    // androidNotificationModule registrations below once wave
                    // 8A lands (CoreDataWorkerFactory/NotificationWorkerFactory
                    // live there):
    ...
    override fun onCreate() {
        ...
        startKoin {
            modules(
                ...
                // TODO(8A-merge): legacy core:data remainder (Hilt-extinct after
                // wave 8A — DataModule.kt etc. become Koin defs here). Uncomment
                // both lines below when 8A lands:
                // androidCoreDataModule(this@JellyPlayApplication),
                // androidNotificationModule(this@JellyPlayApplication),
                // TODO(8A-merge): core:ui UserMessageBus single (wave 8A).
                // androidCoreUiModule,
